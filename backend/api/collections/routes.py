...
# Want-to-Read Collection Endpoints

@collections_api.route('/api/collection/want-to-read', methods=['GET'])
def api_get_want_to_read():
    """Get all want-to-read entries from the cache.
    
    Returns:
        Response: The want-to-read cache entries with library status.
    """
    try:
