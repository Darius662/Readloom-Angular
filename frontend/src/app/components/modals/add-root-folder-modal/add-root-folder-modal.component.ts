...
@Component({
  selector: 'app-add-root-folder-modal',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './add-root-folder-modal.component.html',
  styleUrls: ['./add-root-folder-modal.component.css']
})
export class AddRootFolderModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AddRootFolderModalComponent>,
